...
* #### 栈溢出原理
  ...
  * #### 覆盖函数返回地址调用函数
    ...
    - [**[XMAN]level0**](https://aidaip.github.io/example/2019-02-12-Jarvis-OJ-%E4%BB%8E%E6%89%93%E5%BC%80%E7%BD%91%E7%AB%99%E5%88%B0%E5%8F%8C%E6%89%8B%E7%A6%BB%E5%BC%80%E9%94%AE%E7%9B%98/#xmanlevel0)
  ...
  * #### shellcode
    ...
    **[[XMAN]level1](https://aidaip.github.io/example/2019-02-12-Jarvis-OJ-%E4%BB%8E%E6%89%93%E5%BC%80%E7%BD%91%E7%AB%99%E5%88%B0%E5%8F%8C%E6%89%8B%E7%A6%BB%E5%BC%80%E9%94%AE%E7%9B%98/#xmanlevel1)**
  ...
  * #### ROP
    ...
    * ##### ret2libc
      ...
      * ###### GOT表和PLT表
        ...
        PLT表由代码片段组成，每个代码片段都跳转到GOT表中的一个具体的函数调用 

        ![9](C:\Users\wdbbw\Desktop\9.png)
      ...
      * ###### libc基址泄露
        ...
        * ###### 基本操作
          ...
          * 已知libc
            ...
            `__libc_start_main@got`的地址作为参数传入，这样就会打印出该地址的内容也就是`__libc_start_main`的真实地址

            libc基址加上函数在libc中的偏移地址就是函数的真实地址

            也可以通过泄露某个函数的真实地址计算libc基址

            `libc_base = fun_add - fun_libc `
