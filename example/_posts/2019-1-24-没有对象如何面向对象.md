...
* #### 运算符重载和函数重载
  ...
  * ##### 运算符重载
    ...
    public:
    	int fail_counter = 1;
    	int operator+(find_girfriend f)//重载为成员函数
    	{
    	...
    	friend int operator *(find_girfriend a, int n);//重载为友元函数
    private:
    	int success_counter = 0;
    };
    
    int operator -(find_girfriend a, find_girfriend b)//重载为普通函数
    {
    	return a.fail_counter - b.fail_counter;
    }
    int operator *(find_girfriend a, int n )
    {
