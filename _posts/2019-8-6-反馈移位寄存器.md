...
* ### 反馈移位寄存器
  ...
  ![1](D:\Ai\GitHub\images\反馈移位寄存器\1.png)
  ...
  ![3](D:\Ai\GitHub\images\反馈移位寄存器\3.jpg)
...
* ### 线性反馈移位寄存器(LFSR)
  ...
  ![4](D:\Ai\GitHub\images\反馈移位寄存器\4.jpg)

  $(a_i,a_{i+1},...,a_{i+n-1}) \rightarrow (a_{i+1},...,a_{i+n-1},a_{i+n})$ 

  这个线性变换为

  ![5](D:\Ai\GitHub\images\反馈移位寄存器\5.png)
  ...
  * ### 基本操作
    ...
    ![2](D:\Ai\GitHub\images\反馈移位寄存器\2.png)
